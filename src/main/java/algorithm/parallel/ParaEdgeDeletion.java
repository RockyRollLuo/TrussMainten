...
public class ParaEdgeDeletion implements Runnable {
     ...
     * constructor
     */
    public ParaEdgeDeletion(Graph graph, Edge e0, Hashtable<Edge, Integer> trussMap, Hashtable<Edge, Boolean> edgeVisitedMap) {
        this.graph = graph;
        this.e0 = e0;
